# ====================================================================================
# Setup Project
PROJECT_NAME := provider-remoteexec
...
XPKGS = provider-remoteexec
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-remoteexec: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider RemoteExec CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider RemoteExec controllers
...
# This target prepares repo for your provider by replacing all "remoteexec"
