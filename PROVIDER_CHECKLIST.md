...
The [provider-remoteexec](https://github.com/crossplane/provider-remoteexec) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-remoteexec](https://github.com/crossplane-contrib/provider-jet-remoteexec) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-remoteexec/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-remoteexec/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-remoteexec/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-remoteexec/blob/main/hack/boilerplate.go.txt)
...
The [provider-remoteexec](https://github.com/crossplane/provider-remoteexec)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-remoteexec/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-remoteexec/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue remoteexecs (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-remoteexec/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request RemoteExecs: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-remoteexec/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
